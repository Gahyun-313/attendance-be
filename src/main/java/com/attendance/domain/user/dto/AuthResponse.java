...
/** 인증 응답 DTO - 로그인 성공 / 토큰 갱신 시 클라이언트에게 반환하는 응답 객체 */
@Getter
@Builder
@AllArgsConstructor
public class AuthResponse {
  ...
  /** 로그인 응답 생성 - Access Token, Refresh Token, 사용자 정보를 모두 포함 */
  ...
  /** 토큰 갱신 응답 생성 - Access Token만 새로 발급하고, Refresh Token과 사용자 정보는 포함하지 않음 */
