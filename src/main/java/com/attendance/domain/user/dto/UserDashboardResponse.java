...
/**
 * 사용자 대시보드 응답 DTO - GET /api/users/dashboard (ADMIN)
 * 사용자 관리 화면 상단 요약 카드용.
 * StatisticsService의 OverallStatisticsResponse와는 별개로 "사용자 목록" 화면에 특화된 4개 지표만 제공
 */
@Getter
@Builder
@AllArgsConstructor
...
public class UserDashboardResponse {
    ...
    public static UserDashboardResponse of(
            long totalUsers, long activeUsers, long present, long late, long absent, long newUsersThisMont) {
